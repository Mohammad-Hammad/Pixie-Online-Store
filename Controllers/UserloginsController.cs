...
namespace WebApplication11.Controllers
{
    public class UserloginsController : Controller
    {
        ...
        {
            var modelContext = _context.Userlogins.Include(u => u.Customer).Include(u => u.User);
            return View(await modelContext.ToListAsync());
        }
        public async Task<IActionResult> viewUserLogins()
        {
            var modelContext = _context.Userlogins.Include(u => u.Customer).Include(u => u.User);
            return View(await modelContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,Roleid,Customerid,Userid")] Userlogin userlogin)
        {
            ...
            ViewData["Customerid"] = new SelectList(_context.Customers, "CusId", "CusId", userlogin.Customerid);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Username,Password,Roleid,Customerid,Userid")] Userlogin userlogin)
        {
            if (id != userlogin.Id)
            {
                return NotFound();
