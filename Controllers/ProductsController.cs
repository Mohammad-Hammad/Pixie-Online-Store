...
namespace WebApplication11.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ModelContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("ProId,Name,Sale,Price,Imagename,Categoryid,ImageFile")] Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                product.Imagename = name;//store name in DB
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("ProId,Name,Sale,Price,Imagename,Categoryid")] Product product)
        {
            if (id != product.ProId)
            {
                return NotFound();
